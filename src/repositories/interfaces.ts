import { IRepository, Cliente, Produto, ProdutoImagem, Servico, Vendedor, Embalagem, OrdemServico, PedidoVenda, PedidoVendaItem, FaturaVenda, ContaReceber, ContaPagar, FluxoCaixa, OrdemCompra, OrdemCompraItem, ProdutoComEstoque, EstoqueMovimento, CrmOportunidade, Comissao, DevolucaoVenda, DevolucaoVendaItem, Contrato, ContratoAnexo, NotaEntrada, NotaEntradaItem, DREMensal, Expedicao, Configuracao, ContaPagarAnexo, ContaReceberAnexo, CategoriaFinanceira, FormaPagamento, DashboardStats, FaturamentoMensal } from '../types';
import { VisaoCobranca } from './CobrancasRepository';
